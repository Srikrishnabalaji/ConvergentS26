...
//   ],
//   '2026-03-26': [
//     { id: '3', title: 'Study Group', location: 'PCL 5.102', time: '3:00 PM' }
//   ]
// };
...
//   // Generate marked dates with dots for events
//   const markedDates = useMemo(() => {
//     const marked: Record<string, any> = {};
    
//     // Add dots for all dates with events
//     Object.keys(DUMMY_EVENTS).forEach(date => {
//       marked[date] = {
//         marked: true,
//         dotColor: '#00adf5',
//       };
...
//     // Navigate to map tab with location parameter
//     router.push({
//       pathname: '/(tabs)/map',
...
//         {/* Header matching Groups screen style */}
