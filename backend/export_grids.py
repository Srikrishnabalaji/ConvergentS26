...
Default raster scale is 2 (see DEFAULT_SCALE). Each PDF point becomes
`scale` pixels per axis when rasterizing. Finer scales widen door openings
in pixel space; very low scales can make doorways too narrow for A* to use.
Override with `--scale`.
